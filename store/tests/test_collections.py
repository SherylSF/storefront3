...
class TestCreateCollection:
    def test_if_user_not_authenticated_returns_401(self, create_collection):
    ...
    def test_if_data_is_invalid_returns_201(self, api_client, create_collection, authenticate):
        authenticate(is_staff=True)
...
class TestRetrieveCollection:
    def test_if_collection_exists_returns_200(self, api_client):
        ...
        response = api_client(f'/store/collections/collection_id={collection.id}/')
